...
package com.mycompany.empleado.IUG;
...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Calculador de Sueldo");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(lblSueldoBasico, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cboCategoria, 0, 145, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblSueldoBasico, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblBonificacion, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        btmLimpiar.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon("C:\\Users\\USER\\Documents\\em.png")); // NOI18N
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
         String strHoras = txtHoras.getText().trim();
        String strHijos = txtHijos.getText().trim();

        // Validaciones
        if (strHoras.isEmpty() || strHijos.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Debe ingresar horas y número de hijos", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        if (!strHoras.matches("\\d+") || !strHijos.matches("\\d+")) {
            JOptionPane.showMessageDialog(this, "Solo se permiten números enteros válidos", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        int horas = Integer.parseInt(strHoras);
        int hijos = Integer.parseInt(strHijos);

        if (horas <= 0) {
            JOptionPane.showMessageDialog(this, "Las horas trabajadas deben ser mayores a 0", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Categoría
        String categoria = (String) cboCategoria.getSelectedItem();
        double tarifaHora = categoria.equals("A") ? 30.0 : 25.0;

        // Cálculos
        double sueldoBasico = horas * tarifaHora;
        double bonificacion = hijos * 120.0;
        double descuento = sueldoBasico * 0.10;
        double sueldoNeto = sueldoBasico + bonificacion - descuento;

        // Formato de dinero
        DecimalFormat df = new DecimalFormat("S/ #,##0.00");

        lblSueldoBasico.setText(df.format(sueldoBasico));
        lblBonificacion.setText(df.format(bonificacion));
        lblDescuento.setText(df.format(descuento));
        lblSueldoNeto.setText(df.format(sueldoNeto));
